...
price = dom.xpath('//*[@id="__next"]/div[2]/div[1]/div[2]/div/div[1]/div[5]/div/table/tbody/tr[1]/td[4]/div/span')[0].text
print("The price of Bitcoin is: " + price, "USD.") # Print the price of Bitcoin